...
class SimilarityNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print("Resnet out img: ", [t.shape for t in fm_img]) # DEBUG PRINT
        fm_ref = self.resnet(x[1].unsqueeze(0))
        print("Resnet out ref: ", [t.shape for t in fm_ref]) # DEBUG PRINT
        ...
        print("Conv out ref: ", [t.shape for t in fm_ref]) # DEBUG PRINT
        ...
        print("M res: ", [t.shape for t in M_ref]) # DEBUG PRINT
